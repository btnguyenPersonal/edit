...
SANITIZEFLAGS = # -fsanitize=thread -fno-sanitize-recover=all # TODO(ben): add back in
...
FUZZ_SRCS = $(FUZZ_DIR)/fuzz.cpp $(COMMON_SRCS)
...
fuz: $(BUILD_DIR) $(FUZZ_EXECUTABLE) $(FUZZ_EXECUTABLE)
